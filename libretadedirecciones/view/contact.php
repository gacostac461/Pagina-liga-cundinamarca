...
<html>
    <head>
        <title>Libreta de dirección</title>
        ...
        <div class="container" >
            ...
            <div style="width: 40%" class="well">
                <form id="contactSaveForm" name="contactSaveForm" action="../controller/ContactManager.php?action=save" method="post" onsubmit="return validateContactSaveForm()" class="bs-example form-horizontal" >
                    ...
                    <div class="form-group" >
                        <label for="lastName" class="control-label">Appellido</label>
                    ...
                    <button type="submit" id="save" name="save" value="save" class="btn btn-primary">Guardar</button>
                    <button type="button" id="cancel" name="cancel" value="cancel" onclick="javascript:location.href = '../view/list.php';" class="btn btn-primary">Cancelar</button>
